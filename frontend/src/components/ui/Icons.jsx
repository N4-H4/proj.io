// Proj.io SVG Icon Components — Sketch/Notebook style
...
export function DeadlinesIcon({ size = 20, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function NotebookIcon({ size = 28, className = '' }) {
  return (
...
export function BrainIcon({ size = 20, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M9.5 2A5.5 5.5 0 0 0 4 7.5c0 1.47.58 2.8 1.52 3.78A5.5 5.5 0 0 0 4 15c0 2.76 2.24 5 5 5h.5" />
      <path d="M14.5 2A5.5 5.5 0 0 1 20 7.5c0 1.47-.58 2.8-1.52 3.78A5.5 5.5 0 0 1 20 15c0 2.76-2.24 5-5 5h-.5" />
      <line x1="12" y1="2" x2="12" y2="22" />
    </svg>
  );
}

export function WorkflowIcon({ size = 20, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function KanbanIcon({ size = 20, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
